...
3. You will then be asked to complete some tasks using different rotation controllers. The documentation for the rotation controllers is presented in a booklet in front of you. It will also be shown before using that controller. 
