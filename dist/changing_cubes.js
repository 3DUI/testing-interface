...
define(["dist/build_scene", "dist/render_loop", "dist/basic_cube_controller", "dist/mouse_input_bus"], function (SceneBuilder, RenderLoop, CubeController, MouseInputBus) {
    return function () {
        var views = [{ left: 0,
            ...
            width: 0.5,
            height: 1.0,
            background: new THREE.Color().setRGB(0.5, 0.5, 0.7) }, { left: 0.5,
            bottom: 0,
            width: 0.5,
            height: 1.0,
            background: new THREE.Color().setRGB(0.5, 0.5, 0.5) }, { left: 0,
            bottom: 0,
            height: 1,
            width: 1,
        ...
        var mouseDownListener = function mouseDownListener(name, event) {};

        inputBus.registerConsumer("down", "saveLog", mouseDownListener);
    };
});
//# sourceMappingURL=changing_cubes.js.map
